...
const handlesubmit = (e)=>{
  ...
  }else if(error.name || error.difficulty || error.duration || error.season){
  ...
  return (
    <div>
      ...
      <form onSubmit={e=>handlesubmit(e)}>
        ...
        <input type="text" className={styleForm.input} name='name' id='name' onChange={e=>handlechange(e)}/>
        <br></br>
        {error.name &&(
            <p className={styleForm.danger}>{error.name}</p>
          )}
          <br></br>
        <label>Dificulty</label>
        <br></br>
        <input type="radio" value="1" name="difficulty" id="1"  onChange={e=>handlechange(e)}/>
        <label htmlFor="1">1</label><br></br>
        <input type="radio" value="2" name="difficulty" id="2" onChange={e=>handlechange(e)}/>
        <label htmlFor="2">2</label><br></br>
        <input type="radio" value="3" name="difficulty" id="3" onChange={e=>handlechange(e)}/>
        <label htmlFor="3">3</label><br></br>
        <input type="radio" value="4" name="difficulty" id="4" onChange={e=>handlechange(e)}/>
        <label htmlFor="4">4</label><br></br>
        <input type="radio" value="5" name="difficulty" id="5" onChange={e=>handlechange(e)}/>
        <label htmlFor="5">5</label><br></br>
        {error.difficulty &&(
            <p className={styleForm.danger}>{error.difficulty}</p>
          )}
        <label htmlFor="duration">Duration</label><br></br>
        <input type="number" className={styleForm.input} name="duration"id="duration" onChange={e=>handlechange(e)}/>
        {error.duration &&(
            <p className={styleForm.danger}>{error.duration}</p>
          )}
        <br></br>
        <label>Season</label><br></br>
        <input type="radio" value="Summer" name="season" id="Summer" onChange={e=>handlechange(e)}/>
        <label htmlFor="Summer">Summer</label><br></br>
        <input type="radio" value="Autumn" name="season" id="Autumn" onChange={e=>handlechange(e)}/>
        <label htmlFor="Autumn">Autumn</label><br></br>
        <input type="radio" value="Winter" name="season" id="Winter" onChange={e=>handlechange(e)}/>
        <label htmlFor="Winter">Winter</label><br></br>
        <input type="radio" value="Spring" name="season" id="Spring" onChange={e=>handlechange(e)}/>
        <label htmlFor="Spring">Spring</label><br></br>
        {error.season &&(
            <p className={styleForm.danger}>{error.season}</p>
          )}
        <div>
          <br></br>
        <label >Country: </label>
        <br></br>
       <select className={styleForm.select} onChange={e=>handleselect(e)}>
        ...
        <button className={styleForm.buttonsubmit} type="submit">Create Activity</button>
      </form>
      </div>
    </div>
  )
